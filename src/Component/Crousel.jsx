...
function Crousel({ Data }) {
    ...
    if (!jawSummary) return <p>Loading...</p>;

    const rating = Math.round(jawSummary?.rating?.average || 0);
    const stars = [];
    ...
    return (
        <section className="p-5">
            <div className="flex border rounded-md overflow-hidden shadow-lg max-w-md">
                <div className="flex-none w-40 relative transition-transform duration-300 hover:scale-105 hover:z-10 cursor-pointer">
                    <img
                ...
                <div className="p-3 bg-gray-900 text-white flex-1">
                    <h3 className="text-lg font-semibold">{jawSummary.title}</h3>
                    ...
                    {jawSummary.synopsis && (
                        <p className="text-sm text-gray-300 line-clamp-3">{jawSummary.synopsis}</p>
                    )}
                </div>
            </div>
        </section>
